...
function Login() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-md min-w-0">
        <div className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-8 border dark:border-slate-700">
          {/* Logo/Header */}
